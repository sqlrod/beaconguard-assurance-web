...
const prior1440 = path.resolve(
  __dirname,
  "../pass-01b-r3a-control-fabric-art-direction/crops/control-fabric-1440.png"
);
const prior390 = path.resolve(
  __dirname,
  "../pass-01b-r3a-control-fabric-art-direction/crops/control-fabric-390.png"
);
const priorHero1440 = path.resolve(
  __dirname,
  "../pass-01b-r3a-control-fabric-art-direction/crops/control-fabric-in-hero-1440.png"
);
...
async function crop(selector, filename, width, height) {
  ...
  if (!el) {
    errors.push(`missing crop selector ${selector}`);
    return null;
  }
...
const cf1440 = await crop('[data-crop="control-fabric"]', "control-fabric-corrected-1440.png", 1440, 900);
await crop('[data-crop="control-fabric"]', "control-fabric-corrected-1920.png", 1920, 1080);
await crop('[data-crop="control-fabric"]', "control-fabric-corrected-1024.png", 1024, 768);
await crop('[data-crop="control-fabric"]', "control-fabric-corrected-768.png", 768, 1024);
const cf390 = await crop('[data-crop="control-fabric-mobile"]', "control-fabric-corrected-390.png", 390, 844);
const hero1440 = await crop('[data-crop="control-fabric-in-hero"]', "control-fabric-corrected-in-hero-1440.png", 1440, 900);
await crop('[data-crop="control-fabric-in-hero"]', "control-fabric-corrected-in-hero-390.png", 390, 844);
...
await compare(prior1440, cf1440, "r3a-vs-r3a1-1440.png", "R3A", "R3A1 corrected");
await compare(prior390, cf390, "r3a-vs-r3a1-390.png", "R3A", "R3A1 corrected");
await compare(priorHero1440, hero1440, "r3a-vs-r3a1-in-hero-1440.png", "R3A hero", "R3A1 hero");
...
fs.writeFileSync(
  ...
  JSON.stringify(
    {
      pass: "01B-R3A1",
      title: "Control Fabric Geometry Correction",
      status: "IMPLEMENTATION_COMPLETE_PENDING_INDEPENDENT_VISUAL_REVIEW",
      starting_staging_head: "95ef793abc1a6a5fcfd76b488c250fb02dd61360",
      preview_port: 4337,
      screenshots,
      errors,
    },
