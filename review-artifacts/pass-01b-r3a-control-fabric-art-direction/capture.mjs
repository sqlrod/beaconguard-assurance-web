...
const priorHome1440 = path.resolve(
  __dirname,
  "../pass-01b-r2-pure-svg-diagram-rebuild/crops/home-pure-svg-1440.png"
);
const priorHome390 = path.resolve(
  __dirname,
  "../pass-01b-r2-pure-svg-diagram-rebuild/crops/home-pure-svg-390.png"
);
...
const cf1440 = await crop('[data-crop="control-fabric"]', "control-fabric-1440.png", 1440, 900);
const cf1920 = await crop('[data-crop="control-fabric"]', "control-fabric-1920.png", 1920, 1080);
const cf1024 = await crop('[data-crop="control-fabric"]', "control-fabric-1024.png", 1024, 768);
const cf768 = await crop('[data-crop="control-fabric"]', "control-fabric-768.png", 768, 1024);
const cf390 = await crop('[data-crop="control-fabric-mobile"]', "control-fabric-390.png", 390, 844);
await crop('[data-crop="control-fabric-in-hero"]', "control-fabric-in-hero-1440.png", 1440, 900);
await crop('[data-crop="control-fabric-in-hero"]', "control-fabric-in-hero-390.png", 390, 844);
...
// R2 vs R3A: use prior home crop vs new fabric crops
await compare(priorHome1440, cf1440, "r2-vs-r3a-1440.png", "R2 home", "R3A fabric");
await compare(priorHome390, cf390, "r2-vs-r3a-390.png", "R2 home", "R3A fabric");
...
fs.writeFileSync(
  ...
  JSON.stringify(
    {
      pass: "01B-R3A",
      title: "Control Fabric Art-Direction Gate",
      status: "IMPLEMENTATION_COMPLETE_PENDING_INDEPENDENT_VISUAL_REVIEW",
      starting_staging_head: "f1a5d4969add55d3804544c6c2fb6ab82e935fe8",
      preview_port: 4336,
      screenshots,
      errors,
    },
